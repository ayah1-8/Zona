...
const AddressForm = ({ checkoutToken, next, test }) => {
  ...
  return (
    <>
      ...
      <FormProvider {...methods}>
        {/* data is spread out for the forminout while i pass the statees that i handle here manually */}
        {/* then data is passed to the handleSubmit in Checkout Component for it to be passed to payment form */}
        <form
